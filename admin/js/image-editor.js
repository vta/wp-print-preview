...
if ( fileEditorObj ) {
    ...
    const config          = {
        ...
        tabsIds:           ['Adjust', 'Resize', 'Annotate', 'Watermark', 'Finetune'], // [TABS.ADJUST, TABS.RESIZE, TABS.ANNOTATE, TABS.WATERMARK, TABS.FINETUNE,], // or ['Adjust', 'Annotate', 'Watermark']
    ...
    // TODO - load error msg if we cannot load Filerobot editor
}
